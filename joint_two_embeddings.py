...
if __name__ == '__main__':
    ...
    joint_embs(src_emb_file_path='sanfrancisco/node/sanfranciso_deepwalk_128d.embeddings',
               targ_emb_file_path='sanfrancisco/node/sanfrancisco_combined_pca_traffic.embeddings',
               output_emb_path='sanfrancisco/node/sanfrancisco_pca_and_deepwalk_128d_traffic.embeddings',
               method='&')
